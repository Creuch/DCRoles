...
public class Database {
    ...
    public static Connection dbConnect(CommandSender sender) throws SQLException {
        ...
        if (DCRoles.instance.getConfig().getString("sql.type").equalsIgnoreCase("mysql")) {
            conn = DriverManager.getConnection("jdbc:mysql://" + DCRoles.instance.getConfig().getString("sql.address") + "/" + DCRoles.instance.getConfig().getString("sql.databaseName"), DCRoles.instance.getConfig().getString("sql.user"), DCRoles.instance.getConfig().getString("sql.password"));
